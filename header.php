<?php require_once('missmatch_functions.php'); ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset=utf-8 />
...
<body>
  <header>
  <div id="header_960">
  <h2 class="logo"><a href="<?php echo isset($_SESSION['username'])? 'PATTERN_VIEW_PROFILE.php': 'first_page.php'?>" class="index"><i class="fa fa-universal-access" aria-hidden="true"></i> Mismatch</a></h2>
  <div id="search-div">
  ...
  if (isset($_SESSION['username'])) { ?>
    <div id="user"><?php echo $_SESSION['username'] ?><i class="fa fa-caret-down" aria-hidden="true"></i></i></a></i>
    <div id="profile_menu">
      <a href="PATTERN_VIEW_PROFILE.php"><i class="fa fa-home" aria-hidden="true"></i> Моя страница</a>
